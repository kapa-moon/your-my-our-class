  ...
  return (
    <div className="min-h-screen bg-white text-black">
      <style jsx>{`
        ...
        .go-to-top-button .material-icons {
          color: #000;
          font-size: 18px;
        }
        .tooltip {
      ...
      {/* Generation Message */}
      {generationMessage && (
        <div className="border-b border-gray-200 bg-blue-50 sticky top-[73px] z-40">
      ...
      <div className="button-group">
        <button 
          className="go-to-top-button tooltip"
          onClick={scrollToTop}
          data-tooltip="Go to the top"
        >
