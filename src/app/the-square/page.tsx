          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                {users.filter((user) => !['test1', 'student_test', 'pilot3', 'pilot1', 'student3', 'pilot2', 'prof324'].includes(user.userName)).length-2} classmates in the square
              </p>
            </div>
            <div className="flex items-center gap-4">
              {/* <button 
        ...
        {users.length === 0 ? (
          ...
          <>
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-8 max-w-7xl mx-auto">
              {users
                .filter((user) => !['test1', 'student_test', 'pilot3', 'pilot1', 'student3', 'pilot2', 'prof324'].includes(user.userName))
                .map((user) => (
                  <SquarePersonaCard 
                    key={user.userId} 
                    user={user}
